...
cur_train_dir = '/ssd/zhangyiyang/tf_eager_object_detection/logs-new'
cur_val_dir = '/ssd/zhangyiyang/tf_eager_object_detection/logs-new/val'
cur_ckpt_dir = '/ssd/zhangyiyang/tf_eager_object_detection/logs-new'
...
def train_one_epoch(dataset, base_model, training_model, optimizer,
    ...
    for image, gt_bboxes, gt_labels, _ in tqdm(dataset):
        ...
        if idx % logging_every_n_steps == 0:
            tf_logging.info('steps %d loss: %.4f, %.4f, %.4f, %.4f, %.4f' % (idx + 1,
